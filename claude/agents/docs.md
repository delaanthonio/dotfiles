...
### Weekly Knowledge Base Health Report
```markdown
## Notion Knowledge Base Status - [Date]

### Statistics
- Total Documents: X
- Active Documents: Y
- Archived Documents: Z
- Documents Updated This Week: N

### Issues Found
- [ ] Outdated documents needing review
- [ ] Duplicate content to consolidate
- [ ] Broken links to fix
- [ ] Uncategorized documents

### Completed Actions
- ✓ Archived [X] outdated documents
